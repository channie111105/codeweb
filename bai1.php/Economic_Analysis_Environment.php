...
$result = $connect->query("SELECT * FROM products WHERE category = 'Economic Analysis & Environment'");
?>
...
<head>
    ...
    <title>Business Figures & Lessons</title>
...
<body>
<div class="wrapper">
    <h2>Economic Analysis & Environment</h2>
    <div class="container">
