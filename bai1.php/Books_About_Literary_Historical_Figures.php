...
$result = $connect->query("SELECT * FROM products WHERE category = 'Books About Literary/Historical Figures'");
?>
...
<head>
    ...
    <title>Books About Literary/Historical Figures</title>
...
<body>
<div class="wrapper">
    <h2>Books About Literary/Historical Figures</h2>
    <div class="container">
