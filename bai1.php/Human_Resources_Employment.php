...
$result = $connect->query("SELECT * FROM products WHERE category = 'Human Resources & Employment'");
?>
...
<head>
    ...
    <title>Human Resources & Employment</title>
...
<body>
<div class="wrapper">
    <h2>Human Resources & Employment</h2>
    <div class="container">
